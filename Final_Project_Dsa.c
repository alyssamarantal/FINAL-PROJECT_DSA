...
// Structure for borrowing records
struct node {
    char student[50];
    char equipment[50];
    char date[20];
...
// Front pointer of the linked list
...
// Sorts equipment alphabetically using Bubble Sort
void sortEquipment() {
...
// Inserts borrowing record into linked list
void insert(char student[], char item[], int priority, char date[], char time[]) {
...
void borrowEquipment() {
    ...
    // Save borrower into linked list
...
// Saves borrow history into text file
void logBorrow(char student[], char item[], char date[], char time[]) {
...
// Saves return history into text file
void logReturn(char student[], char item[]) {
...
int main() {
    ...
    while (1) {
        ...
        switch (choice) {
            ...
            default:
                printf("Invalid choice! Please select between 1 and 12.\n");
        }
    }
